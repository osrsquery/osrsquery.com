...
export var CollectionControl = L.Control.extend({    
    ...
    onAdd: function (map) {
        ...
        this._createControl('<i class="fa fa-copy" style="margin-top:7px;"></i>', container, function(e) {
            this._copyCodeToClipboard();
        });

    
        // Area control
        this._createControl('<img src="/resources/map/area-icon.png" alt="Area" title="Area" height="30" width="30">', container, function(e) {
            this._toggleCollectionMode(this._areas, "areas_converter", e.target);
        });        
 
        // Poly Area control
        this._createControl('<img src="/resources/map/polyarea-icon.png" alt="Poly Area" title="Poly Area" height="30" width="30">', container, function(e) {
            this._toggleCollectionMode(this._polyArea, "polyarea_converter", e.target);
        });

        // Path control
        this._createControl('<img src="/resources/map/path-icon.png" alt="Path" title="Path" height="30" width="30">', container, function(e) {
            this._toggleCollectionMode(this._path, "path_converter", e.target);
        });

        // Dax Path control
        this._createControl('<img src="/resources/map/dax-path-icon.png" alt="Dax Path" title="Dax Path" height="25" width="30">', container, function(e) {
            this._toggleCollectionMode(this._daxPath, "path_converter", e.target);
        });

        // Undo control
        this._createControl('<i class="fa fa-undo" style="margin-top:7px;" aria-hidden="true"></i>', container, function(e) {
        ...
        // Clear control
        this._createControl('<i class="fa fa-trash" style="margin-top:7px;" aria-hidden="true"></i>', container, function(e) {
            if (this._currentDrawable !== undefined) {
