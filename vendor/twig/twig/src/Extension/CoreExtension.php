...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters(): array
    {
        return [
            ...
            new TwigFilter('format_username', 'custom_format_username'),
            new TwigFilter('format_url', 'custom_format_url'),
            new TwigFilter('format_page_url', 'custom_format_page_url'),
            new TwigFilter('getLvlFromExp', 'custom_getLvlFromExp'),
            new TwigFilter('format_bytes', 'custom_format_bytes'),
